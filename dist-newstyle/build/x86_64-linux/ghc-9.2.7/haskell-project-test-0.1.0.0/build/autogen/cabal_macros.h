...
/* package haskell-project-test-0.1.0.0 */
#ifndef VERSION_haskell_project_test
#define VERSION_haskell_project_test "0.1.0.0"
#endif /* VERSION_haskell_project_test */
#ifndef MIN_VERSION_haskell_project_test
#define MIN_VERSION_haskell_project_test(major1,major2,minor) (\
  (major1) <  0 || \
  (major1) == 0 && (major2) <  1 || \
  (major1) == 0 && (major2) == 1 && (minor) <= 0)
#endif /* MIN_VERSION_haskell_project_test */
...
#define CURRENT_PACKAGE_KEY "haskell-project-test-0.1.0.0-inplace"
#endif /* CURRENT_packageKey */
#ifndef CURRENT_COMPONENT_ID
#define CURRENT_COMPONENT_ID "haskell-project-test-0.1.0.0-inplace"
