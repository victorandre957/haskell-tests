...
class Q2 {
    void main ( ) {
        ...
        //      'clienteComContaBonificada' foi declarada como 'const'
        clienteComContaBonificada = new Cliente();
