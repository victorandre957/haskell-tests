...
class Q1 {
    void main ( ) {
        ...
        //      não podemos atribuir um tipo menos específico a um tipo mais específico
        const ContaBonificada contaBonificada = new Conta();
