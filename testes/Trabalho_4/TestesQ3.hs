...
class Q3 {
    void main ( ) {
        ...
        //      nunca será possível fazer um cast direto de 'Cliente' para 'Conta'.
        const Conta cn =  <Conta> clienteComContaNormal;
